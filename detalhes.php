...
<head>
    ...
    <style>
        body { background-color: #f9f9f9; font-family: 'Rubik', sans-serif; }
        .produto-container { padding: 100px 20px 60px; }
        .imagem-box { background: #fff; padding: 25px; border-radius: 25px; box-shadow: 0 10px 25px rgba(0,0,0,0.07); }
        .imagem-box img { width: 100%; max-height: 500px; object-fit: contain; }
        .info-produto h1 { font-weight: 700; font-size: 2.2rem; color: #8b0000; margin-bottom: 10px; }
        .preco-produto { font-size: 1.8rem; color: #28a745; font-weight: bold; }
        .descricao-produto { font-size: 1.05rem; color: #555; margin: 20px 0; white-space: pre-line; }
        .extra-info { margin-bottom: 20px; }
        .extra-info i { color: #8b0000; margin-right: 8px; }
        .botoes-produto { display: flex; flex-direction: column; gap: 15px; }
        .botoes-produto .btn { font-weight: 600; font-size: 1rem; padding: 12px; border-radius: 12px; }
        .carousel .card { height: 320px; display: flex; flex-direction: column; justify-content: space-between; }
        .carousel .card img { height: 180px; object-fit: contain; width: 100%; border-radius: 8px 8px 0 0; background-color: #fff; }
    </style>
</head>
<body>
<!-- NAVBAR -->
