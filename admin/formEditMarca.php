...
<body>
    <div class="marca-box">
        ...
        <form action="updateMarca.php" method="POST" enctype="multipart/form-data">
            <div class="mb-3">
                <input type="hidden" name="id_marca" value="<?php echo $marca['id_marca']; ?>">
                <label for="nome" class="form-label">Nome</label>
                <input type="text" class="form-control" id="nome" name="nome" placeholder="Digite o nome" required value="<?php echo htmlspecialchars($marca['nome']); ?>">
            </div>
